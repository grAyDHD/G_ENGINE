...
typedef void (*fp)(
    void); // this is the definition you will find in gba.h.  It is just
           // delaring fp to represent a pointer to a function
...
#define INT_VCOUNT                                                             \
  0x0004 // you can set the display to generate an interrupt when it reaches a
         // particular line on the screen
...
#define INT_ALL                                                                \
  0x4000 // this is just a flag we can set to allow the my function to enable or
         // disable all interrupts. Doesn't actually correspond to a bit in
         // REG_IE
...
#define SOUND3SETBANK0                                                         \
  0x0000 // Bank to play 0 or 1 (non set bank is written to)
...
#define REG_BG2PA                                                              \
  *(u16 *)0x4000020 // Background 2 PA Rotation (pa = x_scale * cos(angle);)
#define REG_BG2PB                                                              \
  *(u16 *)0x4000022 // Background 2 PB Rotation (pb = y_scale * sin(angle);)
#define REG_BG2PC                                                              \
  *(u16 *)0x4000024 // Background 2 PC Rotation (pc = x_scale * -sin(angle);)
#define REG_BG2PD                                                              \
  *(u16 *)0x4000026 // Background 2 PD Rotation (pd = y_scale * cos(angle);)
...
#define REG_BG3PA                                                              \
  *(u16 *)0x4000030 // Background 3 PA Rotation (pa = x_scale * cos(angle);)
#define REG_BG3PB                                                              \
  *(u16 *)0x4000032 // Background 3 PB Rotation (pb = y_scale * sin(angle);)
#define REG_BG3PC                                                              \
  *(u16 *)0x4000034 // Background 3 PC Rotation (pc = x_scale * -sin(angle);)
#define REG_BG3PD                                                              \
  *(u16 *)0x4000036 // Background 3 PD Rotation (pd = y_scale * cos(angle);)
...
#define REG_WIN0H                                                              \
  *(u16 *)0x4000040 // Window 0 X coords (bits 0-7 right, bits 8-16 left)
#define REG_WIN1H                                                              \
  *(u16 *)0x4000042 // Window 1 X coords (bits 0-7 right, bits 8-16 left)
#define REG_WIN0V                                                              \
  *(u16 *)0x4000044 // Window 0 Y coords (bits 0-7 bottom, bits 8-16 top)
#define REG_WIN1V                                                              \
  *(u16 *)0x4000046 // Window 1 Y coords (bits 0-7 bottom, bits 8-16 top)
...
#define REG_SCD0                                                               \
  *(u16 *)0x4000120 // 32-bit Normal Serial Communication Data 0 / Multi-play
#define REG_SCD1                                                               \
  *(u16 *)0x4000122 // 32-bit Normal Serial Communication Data 1 /Multi-play
