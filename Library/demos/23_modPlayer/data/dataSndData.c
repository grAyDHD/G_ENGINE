...
const SampleHeader dMod0SmpTable[] = {
    {17, 0, 64, 0, 16, dSmpData0},  {65, 0, 64, 0, 64, dSmpData1},
    {8, 0, 32, 0, 8, dSmpData2},    {8, 0, 16, 0, 8, dSmpData3},
    {8, 0, 64, 0, 8, dSmpData4},    {1123, 0, 48, 0, 0, dSmpData5},
    {1505, 0, 64, 0, 0, dSmpData6}, {1463, 0, 64, 0, 0, dSmpData7},
};
