...
fillFrameBackground:
  ...
  add r0, r0, r0                         @ r5 doubled for byte offset 
  ldr r1, =0x6000000                     @ r1 = start of VRAM
  add r1, r1, r0                         @ r1 = vram offset
  add r0, r3, r0                         @ r0 = image offset
  ldr r3, =0x7C1F                        @ r3 = transparency value
  mov r4, #480                           @ screen width in bytes
  sub r4, r4, r2
  sub r4, r4, r2                         @ subtract size times 2
...
ColLoop:
  ...
  beq SkipRestore                        @ If equal, no restore
